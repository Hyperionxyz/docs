...
* [How to Place a Recurring Order](guides/how-to-place-a-recurring-order.md)
...
* [via SDK](developer/via-sdk.md)
  ...
  * [Features Available](developer/via-sdk/features-available/README.md)
    * [Get pools](developer/via-sdk/features-available/get-pools.md)
    * [Get positions](developer/via-sdk/features-available/get-positions.md)
    * [Get ticks](developer/via-sdk/features-available/get-ticks.md)
    * [Create pool](developer/via-sdk/features-available/create-pool.md)
...
* [via Contract](developer/via-contract/README.md)
  * [Get Started](developer/via-contract/get-started.md)
  * [Data structure](developer/via-contract/data-structure.md)
  * [Features available](developer/via-contract/features-available/README.md)
    * [Create pool](developer/via-contract/features-available/create-pool.md)
    * [Swap](developer/via-contract/features-available/swap.md)
...
* [Hyperauth (Passkey)](security/hyperauth-passkey/README.md)
  * [Passkey Recovery Guide](security/hyperauth-passkey/passkey-recovery-guide.md)
